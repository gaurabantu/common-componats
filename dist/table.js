...
var TextInputSearch = ({
  ...
  const suffixForInput = suffix !== void 0 ? suffix : showSearchButton ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "button",
    {
      type: "button",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { id: labelId, htmlFor: id, className: "visually-hidden", children: ariaLabel }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          TextInput_default,
          {
            ...
            prefix: leftIcon ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Icon_default,
              {
                src: leftIcon,
        ...
        errorMessage && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { id: errorId, role: "alert", className: "visually-hidden", children: errorMessage })
      ]
    }
  );
};
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            ...
            className: cls3(shape === "default" ? checkboxColorClass : "", inputLabelSpacingClass),
            style: inputStyle
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
...
function TableHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("thead", { className, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("tr", { children: [
    expandable && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { scope: "col", style: { width: 40 }, "aria-label": "Expand" }),
    selectionMode === "multiple" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { scope: "col", style: { width: 48 }, "aria-label": "Select all", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      Checkbox_default,
      {
    ...
    selectionMode === "single" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { scope: "col", style: { width: 48 }, "aria-label": "Select" }),
    visibleColumns.map((col) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "th",
      {
        scope: "col",
        className: cls2(
        ...
        children: [
          ...
          col.sortable && sortState.key === col.key && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "table-sort-icon", "aria-hidden": true, children: sortState.dir === "asc" ? " \u25B2" : sortState.dir === "desc" ? " \u25BC" : "" })
        ]
      },
      col.key
    ))
...
function TableRow({
  ...
  var _a, _b, _c, _d;
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_react6.default.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "tr",
      {
        ...
        children: [
          expandable && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { style: { width: 40 }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "table-expand-btn-icon", "aria-hidden": true, children: "\u25B6" })
            }
          ) }),
          selectionMode === "multiple" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            Checkbox_default,
            {
              name: "table-row",
              value: rowKeyValue,
          ...
          selectionMode === "single" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "text-center", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "input",
            {
              type: "radio",
          ...
          visibleColumns.map((col) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TableCell, { align: col.align, children: renderCell(col, row, rowIndex) }, col.key))
        ]
      }
    ),
    expandable && isExpanded && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("tr", { className: "table-expanded-row", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "td",
      {
...
function TableInner({
  ...
  const [sortState, setSortState] = (0, import_react7.useState)({ key: "", dir: null });
  ...
  const [itemsPerPage, setItemsPerPage] = (0, import_react7.useState)((_b = paginationConfig.pageSize) != null ? _b : 10);
  const selectedSet = (0, import_react7.useMemo)(() => {
  ...
  const expandedSet = (0, import_react7.useMemo)(() => {
  ...
  const visibleColumns = (0, import_react7.useMemo)(() => columns.filter((c) => !c.hidden), [columns]);
  ...
  const handleExpand = (0, import_react7.useCallback)(
    (key) => {
  ...
  const renderCell = (column, row, rowIndex) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TextView_default, { as: "span", children: val != null ? String(val) : "" });
  };
  ...
  const tableContent = /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    "table",
    {
      className: cls2(
        config.table,
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("tbody", { className: "table-tbody", children: shouldUseSkeleton ? Array.from({ length: Math.max(1, loadingRows) }).map((_, idx) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("tr", { className: "table-skeleton-row", "aria-hidden": "true", children: Array.from({ length: visibleColumns.length + extraColumnsCount }).map((__, cellIdx) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "table-skeleton-line" }) }, `table-skeleton-cell-${idx}-${cellIdx}`)) }, `table-skeleton-row-${idx}`)) : paginatedData.map((row, idx) => {
        ...
        footer && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("tfoot", { children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("tr", { children: footer }) })
      ]
    }
  );
  ...
  const searchBar = showSearchBar && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { marginBottom: 0, maxWidth: typeof searchMaxWidth === "number" ? `${searchMaxWidth}px` : searchMaxWidth, flex: toolbarRight ? "0 1 auto" : "1 1 auto" }, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
  ...
  const toolbarContent = toolbar != null ? toolbar : hasToolbar ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "table-toolbar", children: [
    leftContent && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "table-toolbar-left", children: leftContent }),
    toolbarRight && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "table-toolbar-right", children: toolbarRight })
  ] }) : null;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: wrapperClass, style: { position: "relative" }, "aria-busy": loading, children: [
    toolbarContent,
    showLoadingOverlay && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "div",
      {
        ...
        "aria-live": "polite",
        "aria-busy": "true",
        children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TextView_default, { children: "Loading..." })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "div",
      {
        ...
        children: sortedData.length === 0 && !loading ? emptyComponent != null ? emptyComponent : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "table-empty", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TextView_default, { as: "p", children: emptyText }) }) : tableContent
      }
    ),
    showPagination && totalPages > 1 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "table-pagination", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "table-pagination-nav", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "button",
          {
            type: "button",
        ...
        renderPageNumbers().map(
          (page, i) => page === "..." ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "table-pagination-ellipsis", children: "\u2026" }, `ellipsis-${i}`) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "button",
            {
              type: "button",
              className: cls2(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TextView_default, { as: "small", style: { color: "var(--color-text-secondary, #666)" }, children: "Show" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { minWidth: 70 }, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          Select_default,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(TextView_default, { as: "small", style: { color: "var(--color-text-secondary, #666)" }, children: [
          "of ",
          totalItems,
          " ",
...
function Table(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TableInner, { ...props });
}

// src/components/molecules/Table/TablePrimitives.tsx
var import_react8 = require("react");
var import_jsx_runtime10 = require("react/jsx-runtime");
var TableRoot = (0, import_react8.forwardRef)(function TableRoot2({ className, containerClassName, children, ...rest }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: cls2("table-ui-wrap", containerClassName), children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("table", { ref, className: cls2("table-ui", className), ...rest, children }) });
});
TableRoot.displayName = "TableRoot";
var TableCaption = (0, import_react8.forwardRef)(
  function TableCaption2({ className, ...rest }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("caption", { ref, className: cls2("table-ui-caption", className), ...rest });
  }
);
TableCaption.displayName = "TableCaption";
var TableHeader2 = (0, import_react8.forwardRef)(
  function TableHeader3({ className, ...rest }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("thead", { ref, className: cls2("table-ui-thead", className), ...rest });
  }
);
TableHeader2.displayName = "TableHeader";
var TableBody = (0, import_react8.forwardRef)(function TableBody2({ className, ...rest }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("tbody", { ref, className: cls2("table-ui-tbody", className), ...rest });
});
TableBody.displayName = "TableBody";
var TableFooter = (0, import_react8.forwardRef)(
  function TableFooter2({ className, ...rest }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("tfoot", { ref, className: cls2("table-ui-tfoot", className), ...rest });
  }
);
TableFooter.displayName = "TableFooter";
var TableRow2 = (0, import_react8.forwardRef)(function TableRow3({ className, ...rest }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("tr", { ref, className: cls2("table-ui-tr", className), ...rest });
});
TableRow2.displayName = "TableRow";
var TableHead = (0, import_react8.forwardRef)(function TableHead2({ className, scope = "col", ...rest }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("th", { ref, className: cls2("table-ui-th", className), scope, ...rest });
});
TableHead.displayName = "TableHead";
var TableCell2 = (0, import_react8.forwardRef)(function TableCell3({ className, ...rest }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("td", { ref, className: cls2("table-ui-td", className), ...rest });
});
