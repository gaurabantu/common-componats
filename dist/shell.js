...
function useRipple(enabled) {
  ...
  const RippleOverlay = bursts.length === 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ucs-ripple-layer", "aria-hidden": "true", children: bursts.map((b) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ucs-ripple-wave", style: { left: b.x, top: b.y } }, b.id)) });
...
var Button = import_react8.default.memo(function Button2({
  children,
  variant = "primary",
  variantClass,
  size = "lg",
  ...
  var _a, _b, _c;
  const hasText = !!children && (typeof children === "string" ? children.trim().length > 0 : import_react8.default.Children.count(children) > 0);
  ...
  const renderIcon = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: wrapperClass || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      Icon_default,
      {
        src: icon,
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    loading && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "btn-spinner", "aria-hidden": "true" }),
  ...
  const body = rippleEnabled ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    rippleApi.RippleOverlay,
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: innerClass, children: content })
  ] }) : content;
  if (href) {
...
var TextInput = (0, import_react9.forwardRef)(({
  ...
  const [verified, setVerified] = (0, import_react9.useState)(isVerified);
  const [showValue, setShowValue] = (0, import_react9.useState)(false);
  const [displayValue, setDisplayValue] = (0, import_react9.useState)(value || "");
  const [isFocused, setIsFocused] = (0, import_react9.useState)(false);
  const actualValueRef = (0, import_react9.useRef)(value || "");
  const inputRef = (0, import_react9.useRef)(null);
  (0, import_react9.useImperativeHandle)(ref, () => inputRef.current, []);
  ...
  const resolvedMaxLength = (0, import_react9.useMemo)(() => {
    if (maxLength !== void 0)
      return maxLength;
    switch (validation) {
      case "name":
  ...
  const resolvedSuffix = suffix !== void 0 ? suffix : type === "search" ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    Icon_default,
    {
      src: search_default,
      alt: "",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: `${fullWidth ? "w-full" : "inline-block"} ${className}`, children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "label",
      {
        ...
        children: [
          label,
          required && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-[var(--color-state-error)] ml-0.5", children: "*" })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "div",
      {
        ...
        children: [
          prefix && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "div",
            {
              style: {
                display: "flex",
          ...
          hasRightAddons && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: (() => {
                const suffixJsx = resolvedSuffix ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  "div",
                  {
                    style: {
                      display: "flex",
                ...
                const clearJsx = allowClear && hasValue && !disabled ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  "button",
                  {
                    type: "button",
                    onClick: handleClear,
                    ...
                    "aria-label": "Clear",
                    children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Icon_default, { src: close_default, alt: "", height: fieldMetrics.clearIconPx, width: fieldMetrics.clearIconPx, "aria-hidden": true })
                  }
                ) : null;
                const toggleJsx = shouldShowToggle ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  "button",
                  {
                    type: "button",
    ...
    (showCount || showVerifiedStatus || error) && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "div",
      {
        style: {
          display: "flex",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
            "div",
            {
              ...
              children: [
                showVerifiedStatus && verified && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Icon_default, { src: verifiedIcon, alt: "", height: statusIconSize, width: statusIconSize, "aria-hidden": true }),
                ...
                error && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Icon_default, { src: errorIcon, alt: "", height: statusIconSize, width: statusIconSize, "aria-hidden": true }),
          ...
          showCount && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
            "span",
            {
              style: {
                fontSize: "var(--text-small-size, 12px)",
...
var TextInputSearch = ({
  ...
  const suffixForInput = suffix !== void 0 ? suffix : showSearchButton ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
    "span",
    {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("label", { id: labelId, htmlFor: id, className: "visually-hidden", children: ariaLabel }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          TextInput_default,
          {
            ...
            prefix: leftIcon ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              Icon_default,
              {
                src: leftIcon,
        ...
        errorMessage && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { id: errorId, role: "alert", className: "visually-hidden", children: errorMessage })
      ]
    }
  );
};
      ...
      "div",
      {
        ...
        children: items.map((item) => {
          const content = /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
            item.icon ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "app-topbar-menu__icon", "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Icon_default, { src: item.icon, width: 18, height: 18, color: "currentColor", decorative: true }) }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "app-topbar-menu__label", children: item.label })
          ] });
          ...
          const node = item.href && !item.disabled ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            "a",
            {
              ...common,
              href: item.href,
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_react10.default.Fragment, { children: node }, item.id);
        })
      }
    ),
    document.body
...
var TOPBAR_SEARCH_ICON = /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("svg", { viewBox: "0 0 24 24", width: 18, height: 18, fill: "none", "aria-hidden": true, children: [
  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("circle", { cx: "11", cy: "11", r: "7", stroke: "currentColor", strokeWidth: "2" }),
  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("path", { d: "M20 20l-4.3-4.3", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" })
] });
var MENU_ICON = /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("svg", { viewBox: "0 0 20 20", width: 20, height: 20, fill: "none", "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("path", { d: "M3 5h14M3 10h14M3 15h14", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) });
function cls3(...parts) {
  return parts.filter(Boolean).join(" ");
}
...
var AppTopbar = ({
  ...
  const rootId = (0, import_react11.useId)();
  ...
  const menuDomId = (0, import_react11.useMemo)(() => `app-topbar-menu-root-${baseId}`, [baseId]);
  ...
  const [mobileSearchOpen, setMobileSearchOpen] = (0, import_react11.useState)(false);
  const [menuOpen, setMenuOpen] = (0, import_react11.useState)(false);
  const menuTriggerWrapRef = (0, import_react11.useRef)(null);
  ...
  const searchField = search ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
      "header",
      {
        ...
        style: rootStyle,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: cls3("app-topbar__inner", classNames == null ? void 0 : classNames.inner), children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: cls3("app-topbar__left", classNames == null ? void 0 : classNames.left), children: [
              showHamburger ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { ref: menuTriggerWrapRef, className: "app-topbar__menu", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                Button_default,
                {
                  type: "button",
                  variant: "ghost",
              ...
              leftSlot,
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "app-topbar__context", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(TitleTag, { className: cls3("app-topbar__title", classNames == null ? void 0 : classNames.title), children: title }) })
            ] }),
            showCenterCell ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
              "div",
              {
                className: cls3(
                  "app-topbar__center",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: cls3("app-topbar__right", classNames == null ? void 0 : classNames.right), children: [
              hideCenterColumn && search ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                Button_default,
                {
                  type: "button",
                  variant: "ghost",
              ...
              actions == null ? void 0 : actions.map((action) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { className: "app-topbar__action-wrap", children: [
                  ...
                  hasBadge ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                    "span",
                    {
              ...
              profile ? profile.onClick ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                "button",
                {
                  type: "button",
                  ...
                  children: (_h = profile.avatar) != null ? _h : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Avatar_default, { size: 32, shape: "circle", name: (_g = profile.name) != null ? _g : "User", ...profile.avatarProps })
                }
              ) : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                "span",
                {
                  ...
                  children: (_l = profile.avatar) != null ? _l : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Avatar_default, { size: 32, shape: "circle", name: (_k = profile.name) != null ? _k : "User", ...profile.avatarProps })
                }
              ) : null,
              rightSlot
            ] })
          ] }),
          hideCenterColumn && mobileSearchOpen && search ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { id: `${searchInputId}-panel`, className: "app-topbar__mobile-search", children: searchField }) : null
        ]
      }
    ),
    hasMenuItems ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      AppTopbarMenu,
      {
        id: menuDomId,
        open: menuOpen,
...
function prepareTopbar(topbar, pinTopbar) {
  if (!pinTopbar || !import_react12.default.isValidElement(topbar) || !isAppTopbarElement(topbar)) {
    return topbar;
  }
  return import_react12.default.cloneElement(topbar, { sticky: false });
}
...
function DashboardShell({
  ...
  const renderInset = (style) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: cls4(DEFAULT_INSET_CLASSNAME, insetClassName), style, children: [
    topbar ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: cls4(DEFAULT_TOPBAR_WRAPPER_CLASSNAME, topbarClassName), style: topbarStyle, children: topbarNode }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: cls4(DEFAULT_CONTENT_CLASSNAME, contentClassName), style: contentStyle, children })
  ] });
  if (!fixed) {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: cls4(DEFAULT_ROOT_CLASSNAME, className), children: [
