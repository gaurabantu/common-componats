...
var ChartTooltip = import_react.default.memo(function ChartTooltip2({
  theme,
  open,
  pointerX,
  pointerY,
  ...
  const [pos, setPos] = (0, import_react.useState)({ left: 0, top: 0 });
  const [enter, setEnter] = (0, import_react.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ds-chart-tooltip__rows", children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ds-chart-tooltip__row", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ds-chart-tooltip__dot", style: { background: item.color }, "aria-hidden": true }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ds-chart-tooltip__name", style: { color: themeColors.legendText }, children: item.name }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ds-chart-tooltip__value", children: item.value })
        ] }, item.name)) })
      ]
    }
  );
...
var LineChartComponent = ({
  ...
  const xLabels = (0, import_react2.useMemo)(() => data.map((d) => {
    var _a2;
    return String((_a2 = d[xAxisKey]) != null ? _a2 : "");
  }), [data, xAxisKey]);
  const [yMin, yMax] = (0, import_react2.useMemo)(() => getValueExtent(data, series), [data, series]);
  const xScale = (0, import_react2.useMemo)(
    () => scaleLinear([0, Math.max(1, data.length - 1)], [0, innerW]),
    [data.length, innerW]
  );
  const yScale = (0, import_react2.useMemo)(
  ...
  const handleMouseLeave = (0, import_react2.useCallback)(() => setTooltip(null), []);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "svg",
          {
            ...
            children: [
              showGrid && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { stroke: gridStroke, strokeDasharray: "3 3", strokeOpacity: 0.6, children: [
                [0.25, 0.5, 0.75].map((t) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "line",
                  {
                    x1: m.left,
                    y1: m.top + innerH * t,
              ...
              paths.map(({ path, points, color, name }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
              ...
              showTooltip && showCrosshair && tooltip !== null && data.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { className: "ds-chart-crosshair", pointerEvents: "none", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "line",
                  {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("g", { fill: themeColors.axisText, fontSize: 11, textAnchor: "middle", children: xLabels.map((label, i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "text",
                {
                  x: m.left + xScale(i),
                  y: m.top + innerH + 16,
        ...
        showTooltip && tooltip && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ChartTooltip,
          {
            theme,
            open: true,
        ...
        showLegend && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "div",
          {
            style: {
              display: "flex",
            ...
            children: series.map((s, i) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: themeColors.legendText }, children: (_b2 = s.name) != null ? _b2 : s.dataKey })
              ] }, s.dataKey);
            })
          }
        )
...
var LineChart_default = import_react2.default.memo(LineChartComponent);
...
var BarChartComponent = ({
  ...
  const [tooltip, setTooltip] = (0, import_react3.useState)(null);
  const w = typeof width === "number" ? width : 400;
  const h = typeof height === "number" ? height : 300;
  const m = {
    top: (_a = margin == null ? void 0 : margin.top) != null ? _a : 10,
  ...
  const [yMin, yMax] = (0, import_react3.useMemo)(() => getValueExtent(data, series), [data, series]);
  const yScale = (0, import_react3.useMemo)(
    () => scaleLinear([yMin, yMax], [innerH, 0]),
    [yMin, yMax, innerH]
  );
  ...
  const handleMouseLeave = (0, import_react3.useCallback)(() => setTooltip(null), []);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "svg",
          {
            ...
            onMouseLeave: handleMouseLeave,
            children: [
              showGrid && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("g", { stroke: gridStroke, strokeDasharray: "3 3", strokeOpacity: 0.6, children: [0.25, 0.5, 0.75].map((t) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                "line",
                {
                  x1: m.left,
                  y1: m.top + innerH * t,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("g", { fill: themeColors.axisText, fontSize: 11, textAnchor: "middle", children: data.map((row, i) => {
                var _a2;
                return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "text",
                  {
...
var BarChart_default = import_react3.default.memo(BarChartComponent);
...
var PieChartComponent = ({
  ...
  const handleSlicePointer = (0, import_react4.useCallback)(
    (e, i) => {
      setHovered(i);
      if (!showTooltip || !containerRef.current)
        return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { display: "flex", alignItems: "center", flex: 1, minHeight: 260 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "svg",
          {
            width: "100%",
            height: "100%",
            ...
            onMouseLeave: handleMouseLeave,
            children: [
              slices.map((slice, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "path",
                {
                  ...
                  children: !showTooltip && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("title", { children: [
                    slice.name,
                    ": ",
                    slice.value,
                    " (",
        ...
        showLegend && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "div",
          {
            ...
            children: data.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: { color: themeColors.legendText }, children: [
                d.name,
                ": ",
                d.value
              ] })
...
var PieChart_default = import_react4.default.memo(PieChartComponent);
...
var AreaChartComponent = ({
  ...
  const innerW = w - m.left - m.right;
  const innerH = h - m.top - m.bottom;
  const [yMin, yMax] = (0, import_react5.useMemo)(
    () => getValueExtent(data, series, stacked),
    [data, series, stacked]
  );
  const xScale = (0, import_react5.useMemo)(
    () => scaleLinear([0, Math.max(1, data.length - 1)], [0, innerW]),
    [data.length, innerW]
  );
  ...
  const finalPaths = (0, import_react5.useMemo)(() => {
    if (stacked) {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "svg",
          {
            ...
            onMouseLeave: handleMouseLeave,
            children: [
              showGrid && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("g", { stroke: gridStroke, strokeDasharray: "3 3", strokeOpacity: 0.6, children: [0.25, 0.5, 0.75].map((t) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                "line",
                {
                  x1: m.left,
                  y1: m.top + innerH * t,
              ...
              finalPaths.map(({ areaPath: ap, linePath: lp, color, name }) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
              ...
              showTooltip && showCrosshair && tooltip !== null && data.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { className: "ds-chart-crosshair", pointerEvents: "none", children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                  "line",
                  {
                    x1: m.left + xScale(tooltip.activeIndex),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("g", { fill: themeColors.axisText, fontSize: 11, textAnchor: "middle", children: data.map((row, i) => {
                var _a2;
                return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: m.left + xScale(i), y: m.top + innerH + 16, children: String((_a2 = row[xAxisKey]) != null ? _a2 : "") }, i);
              }) })
            ]
          }
        ),
          ...
          "div",
          {
            ...
            children: series.map((s, i) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { color: themeColors.legendText }, children: (_b2 = s.name) != null ? _b2 : s.dataKey })
              ] }, s.dataKey);
            })
          }
        )
...
var AreaChart_default = import_react5.default.memo(AreaChartComponent);
