...
import React3, { useCallback, useMemo, useState as useState4 } from "react";
...
function AnimatedLineStroke({
  ...
  const [length, setLength] = useState2(0);
  useLayoutEffect2(() => {
    const el = ref.current;
    if (!el || !pathD) {
      setLength(0);
...
function useChartAnimationProgress(enabled, durationMs, easing, resetKey) {
  ...
  const [progress, setProgress] = useState3(() => !enabled || reduced ? 1 : 0);
  useEffect(() => {
    if (!enabled || reduced) {
      setProgress(1);
      return;
          ...
          "svg",
          {
            ...
            children: [
              showGrid && /* @__PURE__ */ jsxs2("g", { stroke: gridStroke, strokeDasharray: "3 3", strokeOpacity: 0.6, children: [
                [0.25, 0.5, 0.75].map((t) => /* @__PURE__ */ jsx3(
                  "line",
                  {
                    x1: m.left,
                    y1: m.top + innerH * t,
              ...
              paths.map(({ path: pathD, points, color, name }) => /* @__PURE__ */ jsxs2("g", { children: [
                /* @__PURE__ */ jsx3(
                  AnimatedLineStroke,
                  {
                    pathD,
                ...
                showDots && points.map((p, i) => /* @__PURE__ */ jsx3(
                  "circle",
                  {
                    cx: p.x,
                    cy: p.y,
              ...
              /* @__PURE__ */ jsx3("g", { fill: themeColors.axisText, fontSize: 11, textAnchor: "middle", children: xLabels.map((label, i) => /* @__PURE__ */ jsx3(
                "text",
                {
                  x: m.left + xScale(i),
                  y: m.top + innerH + 16,
...
var LineChart_default = React3.memo(LineChartComponent);

// src/components/charts/BarChart.tsx
import React4, { useCallback as useCallback2, useMemo as useMemo2, useRef as useRef3, useState as useState5 } from "react";
      ...
      children: [
        /* @__PURE__ */ jsxs3(
          "svg",
          {
            ...
            onMouseLeave: handleMouseLeave,
            children: [
              showGrid && /* @__PURE__ */ jsx4("g", { stroke: gridStroke, strokeDasharray: "3 3", strokeOpacity: 0.6, children: [0.25, 0.5, 0.75].map((t) => /* @__PURE__ */ jsx4(
                "line",
                {
                  x1: m.left,
                  y1: m.top + innerH * t,
              ...
              /* @__PURE__ */ jsx4("g", { fill: themeColors.axisText, fontSize: 11, textAnchor: "middle", children: data.map((row, i) => {
                var _a2;
                return /* @__PURE__ */ jsx4(
                  "text",
                  {
          ...
          "div",
          {
            ...
            children: series.map((s, i) => {
              ...
              return /* @__PURE__ */ jsxs3("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                ...
                /* @__PURE__ */ jsx4("span", { style: { color: themeColors.legendText }, children: (_b2 = s.name) != null ? _b2 : s.dataKey })
              ] }, s.dataKey);
            })
          }
        )
...
var BarChart_default = React4.memo(BarChartComponent);

// src/components/charts/PieChart.tsx
import React5, { useCallback as useCallback3, useMemo as useMemo3, useRef as useRef4, useState as useState6 } from "react";
...
var PieChartComponent = ({
  ...
  const animKey = useMemo3(() => `${data.map((d) => d.value).join(",")}-${data.length}`, [data]);
  const animProgress = useChartAnimationProgress(
    animCfg.enabled,
    animCfg.durationMs,
    animCfg.easing,
  ...
  return /* @__PURE__ */ jsxs4(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx5("div", { style: { display: "flex", alignItems: "center", flex: 1, minHeight: 260 }, children: /* @__PURE__ */ jsx5(
          "svg",
          {
            width: "100%",
            height: "100%",
            ...
            preserveAspectRatio: "xMidYMid meet",
            onMouseLeave: handleMouseLeave,
            children: /* @__PURE__ */ jsxs4("g", { transform: `translate(${cx} ${cy}) scale(${scaleFactor}) translate(${-cx} ${-cy})`, children: [
              slices.map((slice, i) => /* @__PURE__ */ jsx5(
                "path",
                {
...
var PieChart_default = React5.memo(PieChartComponent);

// src/components/charts/AreaChart.tsx
import React6, { useCallback as useCallback4, useMemo as useMemo4, useState as useState7 } from "react";
      ...
      children: [
        /* @__PURE__ */ jsxs5(
          "svg",
          {
            ...
            onMouseLeave: handleMouseLeave,
            children: [
              showGrid && /* @__PURE__ */ jsx6("g", { stroke: gridStroke, strokeDasharray: "3 3", strokeOpacity: 0.6, children: [0.25, 0.5, 0.75].map((t) => /* @__PURE__ */ jsx6(
                "line",
                {
                  x1: m.left,
                  y1: m.top + innerH * t,
              ...
              /* @__PURE__ */ jsx6("g", { fill: themeColors.axisText, fontSize: 11, textAnchor: "middle", children: data.map((row, i) => {
                var _a2;
                return /* @__PURE__ */ jsx6("text", { x: m.left + xScale(i), y: m.top + innerH + 16, children: String((_a2 = row[xAxisKey]) != null ? _a2 : "") }, i);
              }) })
            ]
          }
        ),
        showTooltip && tooltip && /* @__PURE__ */ jsx6(
          ChartTooltip,
          {
            theme,
            open: true,
          ...
          "div",
          {
            ...
            children: series.map((s, i) => {
              ...
              return /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                ...
                /* @__PURE__ */ jsx6("span", { style: { color: themeColors.legendText }, children: (_b2 = s.name) != null ? _b2 : s.dataKey })
              ] }, s.dataKey);
            })
          }
        )
...
var AreaChart_default = React6.memo(AreaChartComponent);
...
//# sourceMappingURL=chunk-F2J27VCS.mjs.map