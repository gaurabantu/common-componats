...
var CheckboxGlyph = () => /* @__PURE__ */ jsx("svg", { className: "ucs-cc-checkbox-check", "aria-hidden": true, viewBox: "0 0 12 12", children: /* @__PURE__ */ jsx("path", { className: "ucs-cc-checkbox-checkpath", d: "M2.75 6.05 L5.15 9.05 L9.95 3.25" }) });
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          "span",
          {
            ...
            children: /* @__PURE__ */ jsx(CheckboxGlyph, {})
          }
        ),
        /* @__PURE__ */ jsx(
          "span",
    ...
    visibleColumns.map((col) => /* @__PURE__ */ jsxs3(
      "th",
      {
        ...
        children: [
          ...
          col.sortable && /* @__PURE__ */ jsx4("span", { className: "table-sort-icon", "aria-hidden": true, children: sortState.key !== col.key || !sortState.dir ? " \u2195" : sortState.dir === "asc" ? " \u25B2" : " \u25BC" })
        ]
      },
      col.key
    ))
  ...
  return /* @__PURE__ */ jsxs5("div", { className: wrapperClass, style: { position: "relative" }, "aria-busy": loading, children: [
    ...
    showPagination && totalPages > 1 && /* @__PURE__ */ jsxs5("div", { className: "table-pagination", children: [
      ...
      /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ jsx7(TextView_default, { as: "small", style: { color: "var(--color-text-secondary)" }, children: "Show" }),
        ...
        /* @__PURE__ */ jsxs5(TextView_default, { as: "small", style: { color: "var(--color-text-secondary)" }, children: [
          "of ",
          totalItems,
          " ",
...
//# sourceMappingURL=chunk-CKSW7ATG.mjs.map