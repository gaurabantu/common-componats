...
function useRipple(enabled) {
  ...
  const RippleOverlay = bursts.length === 0 ? null : /* @__PURE__ */ jsx2("span", { className: "ucs-ripple-layer", "aria-hidden": "true", children: bursts.map((b) => /* @__PURE__ */ jsx2("span", { className: "ucs-ripple-wave", style: { left: b.x, top: b.y } }, b.id)) });
...
var Button = React3.memo(function Button2({
  children,
  variant = "primary",
  variantClass,
  size = "lg",
  ...
  var _a, _b, _c;
  const hasText = !!children && (typeof children === "string" ? children.trim().length > 0 : React3.Children.count(children) > 0);
  ...
  const renderIcon = () => {
    ...
    return /* @__PURE__ */ jsx3("span", { className: wrapperClass || void 0, children: /* @__PURE__ */ jsx3(
      Icon_default,
      {
        src: icon,
  ...
  const content = /* @__PURE__ */ jsxs(Fragment, { children: [
    loading && /* @__PURE__ */ jsx3("span", { className: "btn-spinner", "aria-hidden": "true" }),
  ...
  const body = rippleEnabled ? /* @__PURE__ */ jsxs(Fragment, { children: [
    rippleApi.RippleOverlay,
    /* @__PURE__ */ jsx3("span", { className: innerClass, children: content })
  ] }) : content;
  if (href) {
...
var TextInput = forwardRef(({
  ...
  const [verified, setVerified] = useState2(isVerified);
  const [showValue, setShowValue] = useState2(false);
  const [displayValue, setDisplayValue] = useState2(value || "");
  const [isFocused, setIsFocused] = useState2(false);
  const actualValueRef = useRef2(value || "");
  ...
  const resolvedSuffix = suffix !== void 0 ? suffix : type === "search" ? /* @__PURE__ */ jsx4(
    Icon_default,
    {
      src: search_default,
      alt: "",
  ...
  return /* @__PURE__ */ jsxs2("div", { className: `${fullWidth ? "w-full" : "inline-block"} ${className}`, children: [
    label && /* @__PURE__ */ jsxs2(
      "label",
      {
        ...
        children: [
          label,
          required && /* @__PURE__ */ jsx4("span", { className: "text-[var(--color-state-error)] ml-0.5", children: "*" })
        ]
      }
    ),
    /* @__PURE__ */ jsxs2(
        ...
        children: [
          ...
          hasRightAddons && /* @__PURE__ */ jsx4(
            "div",
            {
              ...
              children: (() => {
                const suffixJsx = resolvedSuffix ? /* @__PURE__ */ jsx4(
                  "div",
                  {
                    style: {
                      display: "flex",
                ...
                const clearJsx = allowClear && hasValue && !disabled ? /* @__PURE__ */ jsx4(
                  "button",
                  {
                    type: "button",
                    onClick: handleClear,
                    ...
                    "aria-label": "Clear",
                    children: /* @__PURE__ */ jsx4(Icon_default, { src: close_default, alt: "", height: fieldMetrics.clearIconPx, width: fieldMetrics.clearIconPx, "aria-hidden": true })
                  }
                ) : null;
                const toggleJsx = shouldShowToggle ? /* @__PURE__ */ jsx4(
                  "button",
                  {
                    type: "button",
    ...
    (showCount || showVerifiedStatus || error) && /* @__PURE__ */ jsxs2(
      "div",
      {
        style: {
          display: "flex",
        ...
        children: [
          /* @__PURE__ */ jsxs2(
            "div",
            {
              ...
              children: [
                showVerifiedStatus && verified && /* @__PURE__ */ jsxs2(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      /* @__PURE__ */ jsx4(Icon_default, { src: verifiedIcon, alt: "", height: statusIconSize, width: statusIconSize, "aria-hidden": true }),
                      /* @__PURE__ */ jsx4("span", { children: "Verified" })
                    ]
                  }
                ),
                error && /* @__PURE__ */ jsxs2(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx4(Icon_default, { src: errorIcon, alt: "", height: statusIconSize, width: statusIconSize, "aria-hidden": true }),
...
var TextInputSearch = ({
  ...
  const suffixForInput = suffix !== void 0 ? suffix : showSearchButton ? /* @__PURE__ */ jsx5(
    "span",
    {
  ...
  return /* @__PURE__ */ jsxs3(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx5("label", { id: labelId, htmlFor: id, className: "visually-hidden", children: ariaLabel }),
        /* @__PURE__ */ jsx5(
          TextInput_default,
          {
            id,
        ...
        errorMessage && /* @__PURE__ */ jsx5("span", { id: errorId, role: "alert", className: "visually-hidden", children: errorMessage })
      ]
    }
  );
};
...
//# sourceMappingURL=chunk-ULF52PMF.mjs.map